...
$sentencia = $bd->query('select * from moduloinfor where Modelo_idModelo = 2');
...
<div class="container">
      <div class="row">
        ...
        <div class="col-md-4 text-center mt-4">
          <a href="detallesmoduloweb.php?codigo=<?php echo $dato->idVehiculo ?>"><img src="img/<?php echo $dato->foto ?>" class="img-fluid"></a>
          <h2> <?php echo $dato->nomVehiculo; ?> </h2>
          <p> <?php echo $dato->precio; ?> </p>
          <a href="detallesmoduloweb.php?codigo=<?php echo $dato->idVehiculo ?>" class="btn btn-primary">Ver detalles</a>
        </div>
